...
#InstallKeybdHook ; Good reminder to comment, forgot what these do.
#SingleInstance force ; Good reminder to comment, forgot what these do.
...
; Good reminder to comment, forgot what these items below do.
TurnOffSI:
SplashImage, off
...
+^!Down::
PostMessage, 0x111, 18842, 0, , Windows Media Player
return
...
;-------------------------------------------------------------------------------
/*
using :: before trigger requires a space after trigger word
using :*: is instant
*/

:*:ccc::Cinema 4D 
::wdss::Wood Design Studios
::wdsw::http://www.thewooddesign.com
:*:s[::scott@thewooddesign.com
:*:a[::alpinestart@gmail.com
::corr::correspondence
::lq::Let me know if you have any questions!
...
#v::Run C:\Program Files\Adobe\Adobe Illustrator CC 2015\Support Files\Contents\Windows\Illustrator.exe
#c::Run C:\Program Files (x86)\Google\Chrome\Application\chrome.exe
#s::Run H:\Dropbox\_Tools\SublimeText3\sublime_text.exe

;-------------------------------------------------------------------------------
; Favorite Folder Launch
;-------------------------------------------------------------------------------

#1::Run C:\Downloads
#7::Run C:\Dropbox
#9::Run C:\Dropbox\_media
#8::Run C:\Users\Scott Wood\Tools

;-------------------------------------------------------------------------------
; Date Hotkeys
;-------------------------------------------------------------------------------
; "]d" formats current time as M/D/YYYY X:XX PM
:*:]d::
FormatTime, CurrentDateTime,, M/d/yyyy h:mm tt  
SendInput %CurrentDateTime%
return

; "[d" Formats current time as yymmdd
:*:[d::  
